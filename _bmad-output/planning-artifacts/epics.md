...
**Implements:** FR8
**Supports:** AR1, AR2, AR16, AR17, AR18, AR19
...
**Given** 项目骨架将作为后续持续交付的唯一工程基线
**When** 团队检查自动化质量门槛
**Then** 代码库必须至少具备 lint、typecheck、test、migration validation 与 build 的正式执行入口
**And** 必须为 OpenAPI contract validation 保留正式接入点，而不是依赖临时脚本或手工约定

### Story 1.2: Creator Login and Protected Workspace Shell

**Implements:** FR8
**Supports:** NFR8, NFR10, AR3, AR4, AR5, UX-DR17
...
**Implements:** FR1, FR2, FR3, FR7, FR18
...
**Implements:** FR8, FR20, FR21, FR22
**Supports:** NFR1, NFR2, NFR3, UX-DR12, UX-DR15, UX-DR18
...
**Implements:** FR34, FR35, FR36
**Supports:** NFR5, NFR11, AR7, AR14
...
**Implements:** FR26, FR27, FR28, FR29
**Supports:** UX-DR10, UX-DR18
...
**Implements:** FR23, FR29
**Supports:** NFR4, UX-DR11, UX-DR15
...
**Implements:** FR40, FR41, FR43, FR44
**Supports:** NFR13, NFR15
...
**Supports:** UX-DR2, UX-DR3, UX-DR18
...
**Given** 团队验证移动端查看与下载关键路径
**When** 视口宽度小于 768px
**Then** 任务列表、任务详情和下载入口必须保持可用且可读
**And** 移动端主要触控目标必须满足至少 44x44 的最小点击面积
...
**Given** 移动端 review 页面在小屏幕上渲染
**When** 视口宽度小于 768px 且用户执行确认动作
**Then** 待确认片段、关键上下文与动作入口必须保持可读且可操作
**And** 移动端主要触控目标必须满足至少 44x44 的最小点击面积
